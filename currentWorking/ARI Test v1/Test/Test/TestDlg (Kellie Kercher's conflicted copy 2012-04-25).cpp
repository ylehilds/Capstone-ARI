...
void CTestDlg::OnBnClickedOk()
{
	...
	if(v1 != ""){
		TCHAR path[] = TEXT("C:\\Users\\CSRL\\Dropbox\\Capstone-ARI\\currentWorking\\ARI Test v1\\MFPlayer2\\MFPlayer\\Release\\MFPlayer.exe");
		...
		v2+=ln;
	if(v2 != "" && ln != ""){
		TCHAR path2[] = TEXT("C:\\Users\\CSRL\\Dropbox\\Capstone-ARI\\currentWorking\\ARI Test v1\\MFPlayer1\\MFPlayerOwen\\Release\\MFPlayer.exe");
