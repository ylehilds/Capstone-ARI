...
EXTERN_C const IID IID_IPlayerVideo;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE MoveLeft( void) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE MoveRight( void) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE MoveUp( void) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE MoveDown( void) = 0;
...
#define IPlayerVideo_SetBrightness(This,fBrightness)	\
    ( (This)->lpVtbl -> SetBrightness(This,fBrightness) ) 

#define IPlayerVideo_SetContrast(This,fContrast)	\
    ( (This)->lpVtbl -> SetContrast(This,fContrast) ) 

#define IPlayerVideo_MoveLeft(This)	\
    ( (This)->lpVtbl -> MoveLeft(This) ) 

#define IPlayerVideo_MoveRight(This)	\
    ( (This)->lpVtbl -> MoveRight(This) ) 

#define IPlayerVideo_MoveUp(This)	\
    ( (This)->lpVtbl -> MoveUp(This) ) 

#define IPlayerVideo_MoveDown(This)	\
